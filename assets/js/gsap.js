...
gsap.to(".circle", {
  ...
  x: 200,
  y: 100 // xPercent, yPercent: 位置をパーセンテージで指定します。回転・スケール関連
  // rotation: 45,
  // scale: 1.5,
...
gsap.to(".yellow", (_gsap$to = {
  ...
  scale: 1.5,
  backgroundColor: "#ff0000"
}, _defineProperty(_gsap$to, "duration", 2), _defineProperty(_gsap$to, "ease", "Power1.easeInOut"), _defineProperty(_gsap$to, "repeat", -1), _defineProperty(_gsap$to, "yoyo", true), _gsap$to));
gsap.to(".heart", {
  scale: 1.1,
  duration: 1,
  ease: "Power1.easeInOut",
...
gsap.to(".image-wrap", {
  ...
  scrollTrigger: {
    trigger: ".image-wrap",
    start: "top 80%",
    //アニメーションのスタート位置 画面位置/要素位置
    end: "bottom 20%",
    //アニメーションの終了位置　画面位置/要素位置
    markers: true,
    toggleActions: "play none none reverse"
  }
});